...
describe('Form 8801', () => {
  ...
  it('should allow full credit when carryforward is small enough', () => {
    ...
    expect(f8801.l25()).toEqual(0)
  })

  it('should be included in schedules when credit is positive', () => {
    const information = cloneDeep(baseInformation)
    information.f8801Input = {
    ...
    expect(f1040.f8801.credit()).toEqual(500)
    const schedules = f1040.schedules()
    const hasF8801 = schedules.some((s) => s.tag === 'f8801')
    expect(hasF8801).toBe(true)
  })
