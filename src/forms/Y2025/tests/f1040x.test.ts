...
describe('Form 1040X', () => {
  ...
  it('should compute Column C as Column A + Column B', () => {
    ...
    expect(f1040x.l1a()).toBe(75000)
    expect(f1040x.l1b()).toBe(5000)
    expect(f1040x.l1c()).toBe(80000)

    expect(f1040x.l2a()).toBe(15750)
    expect(f1040x.l2b()).toBe(0)
    expect(f1040x.l2c()).toBe(15750)

    expect(f1040x.l3a()).toBe(75000 - 15750)
    expect(f1040x.l3b()).toBe(5000 - 0)
    expect(f1040x.l3c()).toBe(80000 - 15750)
  })
  ...
  it('should compute refund when payments exceed tax', () => {
    ...
    expect(f1040x.l10c()).toBe(10000)
    expect(f1040x.l11c()).toBe(14000)
    expect(f1040x.l12()).toBe(4000)
    expect(f1040x.l15()).toBe(0)
  })
  ...
  it('should compute amount owed when tax exceeds payments', () => {
    ...
    expect(f1040x.l12()).toBe(0)
    expect(f1040x.l15()).toBe(3000)
  })
  ...
  it('should return correct Part III explanation', () => {
    ...
    expect(f1040x.taxYearAmended()).toBe('2024')
  })
