...
describe('Tax rates', () => {
  ...
  it('ordinary taxes for single status should be correct', async () => {
    ...
    // Over $100,000
    const amounts = [
      [100000, 16914], // *0.22-5086.00
      [100001, 16914],
      [103350, 17651], // *0.24-7153.00
      [103351, 17651],
      [197300, 40199], // *0.32-22937.00
      [197301, 40199],
      [250525, 57231], // *0.35-30452.75
      [250526, 57231],
      [626350, 188770], // *0.37-42979.50
      [626351, 188770]
    ]
  ...
  it('ordinary taxes for head of household status should be correct', async () => {
    ...
    const amounts = [
      ...
      [103351, 15912],
      [197300, 38460], // *0.32-24676.00
      [197301, 38460],
      [250500, 55484], // *0.35-32191.00
      [250501, 55484],
      [626350, 187032], // *0.37-44717.50
      [626351, 187032]
    ]
    amounts.forEach(([amount, tax]) => {
