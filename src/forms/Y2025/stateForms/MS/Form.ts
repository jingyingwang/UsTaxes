...
export class MSForm extends StateFormBase {
  f1040: StateF1040
  state: State = 'MS'
  formName = '80-105'
  formOrder = 0
  ...
  stateExemptions = (): number => parameters.exemption
...
const makeMSForm = (f1040: StateF1040): MSForm => new MSForm(f1040)
export default makeMSForm
