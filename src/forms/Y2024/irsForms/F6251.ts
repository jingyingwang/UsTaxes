...
export default class F6251 extends F1040Attachment {
  ...
  isNeeded = (): boolean => {
    ...
    if (this.f1040.f8801.isNeeded()) {
      return true
    }

    // TODO: You claim the qualified electric vehicle credit (Form 8834),
    // the personal use part of the alternative fuel vehicle refueling property credit (Form 8911).
